...
For the scope of layout class support for these keywords, see [Layout Class Syntax](/en/api/layout-class). For view style class support, see the view library documentation for specific views.
...
For specific layout class support, see [Layout Class Syntax](/en/api/layout-class). For view style class support, see the view documentation or view source code.