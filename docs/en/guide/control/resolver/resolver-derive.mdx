...
This macro has built-in view state mechanism, mainly used for view style system. It can work with [class system](/en/guide/use/builder/class), parse class names in `on_update_class` and update styles.
