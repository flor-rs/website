...
Atomic class is a style setting method similar to Tailwind CSS, quickly configuring widget style and layout through space-separated class strings.
...
Style classes are parsed by widgets themselves:

```text
bg-white text-blue-600 rounded-lg shadow-md
```

Different widgets may support different style classes.
